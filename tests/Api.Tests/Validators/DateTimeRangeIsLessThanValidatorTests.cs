...
public class DateTimeRangeIsLessThanValidatorTests
{
    ...
    {
        { new TimeRange(DateTime.Now, DateTime.Now.Add(TimeSpan.FromMinutes(29))), TimeSpan.FromMinutes(30) },
        { new TimeRange(DateTime.Now, DateTime.Now.Add(new TimeSpan(29, 23, 59, 59))), TimeSpan.FromDays(30) },
    };
    ...
    {
        { new TimeRange(DateTime.Now, DateTime.Now.Add(TimeSpan.FromMinutes(31))), TimeSpan.FromMinutes(30) },
        { new TimeRange(DateTime.Now, DateTime.Now.Add(new TimeSpan(30, 0, 0, 1))), TimeSpan.FromDays(30) },
    };
